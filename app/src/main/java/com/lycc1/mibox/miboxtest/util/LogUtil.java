...
import com.lycc1.mibox.miboxtest.common.Config;
...
public final class LogUtil {
    ...
    private static boolean sLogSwitch         = Config.DEBUG; // log总开关，默认开
   ...
   public static void ee(final Object contents) {
        log(E, "--damojie--", contents);
    }
