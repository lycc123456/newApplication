package com.lycc1.mibox.miboxtest.framework.support.delegate.view;
...
import com.house.mebikeops.framework.support.delegate.fragment.FragmentMvpDelegate;
import com.house.mebikeops.framework.support.delegate.fragment.FragmentMvpDelegateCallback;
import com.house.mebikeops.framework.support.delegate.fragment.FragmentMvpDelegateImpl;
...
public abstract class MvpFragment<V extends MvpView, P extends MvpPresenter<V>>
	...
	public void setUserVisibleHint (boolean isVisibleToUser) {
		...
		getFragmentMvpDelegate().setUserVisibleHint(isVisibleToUser);
	}
	...
	public void onHiddenChanged (boolean hidden) {
		...
		getFragmentMvpDelegate().onHiddenChanged(hidden);
	}
}
